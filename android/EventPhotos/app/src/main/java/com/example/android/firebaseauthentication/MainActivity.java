...
/**
 * Created by taylan on 29.11.2017.
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    // Broadcast receiver. Set new case for new intents when required.
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            switch(intent.getAction()) {
                case "PREFERENCE_CHANGE":
                    switch(intent.getStringExtra("pref_key")) {
                        case "pref_wifi_download":
                            String wifiDownloadImageQuality =
                                    preferences.getString("pref_wifi_download", "full");
                            Log.v("wifi_download", wifiDownloadImageQuality);
                            break;
                        case "pref_wifi_upload":
                            String wifiUploadImageQuality =
                                    preferences.getString("pref_wifi_upload", "full");
                            Log.v("wifi_download", wifiUploadImageQuality);
                            break;
                        case "pref_mobile_data_download":
                            String mobileDownloadImageQuality =
                                    preferences.getString("pref_mobile_download", "full");
                            Log.v("wifi_download", mobileDownloadImageQuality);
                            break;
                        case "pref_mobile_data_upload":
                            String mobileUploadImageQuality =
                                    preferences.getString("pref_mobile_upload", "full");
                            Log.v("wifi_download", mobileUploadImageQuality);
                            break;
                        default:
                            break;
                    }
...
//        FirebaseDatabase.getInstance().setPersistenceEnabled(true);
        ...
        registerReceiver(broadcastReceiver, new IntentFilter("PREFERENCE_CHANGE"));
    }
